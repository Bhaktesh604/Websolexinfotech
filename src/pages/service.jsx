                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0 ">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Node.js Development</h5>
                      <h6 className='col-xxl-9'>Efficient Backend Solutions with Node.js</h6>
                      <p className="mb-1">Leverage the power of Node.js for building fast, scalable, and efficient server-side applications. Our team delivers robust back-end solutions that support real-time data and high traffic.
                      </p>
                    </div>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0 ">
                    <div className="card_body_sub ">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >PHP Development</h5>
                      <h6 className=' col-lg-9'>Versatile Web Solutions with PHP</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Laravel Development</h5>
                      <h6 className='col-lg-9'>Elegant and Efficient Laravel Solutions</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >WordPress Development</h5>
                      <h6 className='col-lg-9'>Customized WordPress Websites</h6>
                      <p className="mb-1 fs-14">Create a strong online presence with our WordPress development services. We design and develop custom WordPress websites that are user-friendly, SEO-optimized, and easy to manage.
                      </p>
                    </div>
                    <div className="social d-flex mt-5 mt-md-4 justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Shopify Development</h5>
                      <h6 className='col-xxl-9'>Ecommerce Excellence with Shopify</h6>
                      <p className="mb-1 fs-14">Transform your ecommerce business with our Shopify development services. We create stunning, user-friendly online stores that offer seamless shopping experiences and are optimized for conversions.
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Angular Development</h5>
                      <h6 className='col-xxl-9'>Powerful Single-Page Applications with Angular</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Wix Development</h5>
                      <h6 className='col-lg-9'>Easy and Elegant Websites with Wix</h6>
                      <p className="mb-1 fs-14">Create beautiful, functional websites effortlessly with our Wix development services. We provide custom design and development to match your brand's unique style and requirements.
                      </p>
                    </div>
                    <div className="social d-flex mt-4 justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Webflow Development</h5>
                      <h6 className='col-lg-9'>Advanced Web Design with Webflow</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Logo Design</h5>
                      <h6 className='col-lg-9'>Crafting Memorable Logos</h6>
                      <p className="mb-1 fs-14">Our logo design service creates unique and memorable logos that perfectly represent your brand's identity. We focus on simplicity, versatility, and timeless appeal to make your brand stand out.
                      </p>
                    </div>
                    <div className="social d-flex mt-5 mt-md-4  justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Infographic Design</h5>
                      <h6 className='col-lg-9'>Visual Storytelling with Infographics</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Packaging Design</h5>
                      <h6 className='col-lg-9'>Innovative Packaging Solutions</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Branding Identity</h5>
                      <h6 className='col-lg-9'>Building Strong Brand Identities</h6>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Website Design</h5>
                      <h6 className='col-lg-9'>Stunning and Functional Websites</h6>
                      <p className="mb-1 fs-14">We create visually stunning and user-friendly websites tailored to your brand and business needs. Our designs focus on aesthetics, functionality, and seamless user experience, ensuring your online presence stands out.
                      </p>
                    </div>
                    <div className="social d-flex mt-4  justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >Application Design</h5>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >UI/UX Design</h5>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold col-12 col-lg-10 text-capitalize mb-2" >iOS Development</h5>
                      <h6 className='col-lg-9'>Exceptional iOS App Development</h6>
                      <p className="mb-1 fs-14">We specialize in creating high-quality iOS apps that offer seamless performance and a great user experience. Our team crafts custom iOS solutions that are visually appealing, intuitive, and optimized for the latest Apple devices.
                      </p>
                    </div>
                    <div className="social d-flex mt-4  justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
                ...
                <div className="card border-0 mb-0">
                  <div className="card-body text-center text-lg-start p-4 border-0">
                    <div className="card_body_sub">
                      ...
                      <h5 className="mb-1 fw-bold  text-capitalize mb-2" >Android Development</h5>
                      <h6 className='col-lg-9'>Innovative Android App Solutions</h6>
                      <p className="mb-1 fs-14">Our Android development service delivers innovative and reliable apps tailored to your business needs. We build feature-rich, secure, and user-friendly Android applications that run smoothly on a wide range of devices.
                      </p>
                    </div>
                    <div className="social d-flex mt-4  justify-content-end gap-1">
                      <a href="javascript:void(0);"><FaArrowRight className="arrow" /></a>
