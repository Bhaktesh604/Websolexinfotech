...
const portfolios = {
    'Web Design': [
        { id: 1, discri: 'Web Design', src: image1, alt: 'Rectangle 11.png' },
        { id: 2, discri: 'Web Design', src: image2, alt: 'Rectangle 12.png' },
        { id: 3, discri: 'Web Design', src: image3, alt: 'Rectangle 13.png' },
        { id: 4, discri: 'Web Design', src: image4, alt: 'Rectangle 14.png' },
    ],
    'App Design': [
        { id: 1, discri: 'App Design', src: image5, alt: 'Rectangle 15.png' },
        { id: 2, discri: 'App Design', src: image6, alt: 'Rectangle 16.png' },
        { id: 3, discri: 'App Design', src: image7, alt: 'Rectangle 17 (2).png' },
        { id: 4, discri: 'App Design', src: image8, alt: 'Rectangle 18.png' },
    ],
    'Graphic Design': [
        { id: 1, discri: 'Graphic Design', src: image9, alt: 'Rectangle 19.png' },
        { id: 2, discri: 'Graphic Design', src: image10, alt: 'Rectangle 20.png' },
        { id: 3, discri: 'Graphic Design', src: image11, alt: 'Rectangle 21.png' },
        { id: 4, discri: 'Graphic Design', src: image12, alt: 'Rectangle 22.png' },
    ],
    'Web Development': [
        { id: 1, discri: 'Web Development', src: image13, alt: 'Rectangle 23.png' },
        { id: 2, discri: 'Web Development', src: image14, alt: 'Rectangle 24.png' },
        { id: 3, discri: 'Web Development', src: image15, alt: 'Rectangle 25.png' },
        { id: 4, discri: 'Web Development', src: image16, alt: 'Rectangle 26.png' },
    ],
    'App Development': [
        { id: 1, discri: 'App Development', src: image17, alt: 'Rectangle 27.png' },
        { id: 2, discri: 'App Development', src: image18, alt: 'Rectangle 28.png' },
        { id: 3, discri: 'App Development', src: image19, alt: 'Rectangle 29.png' },
        { id: 4, discri: 'App Development', src: image20, alt: 'Rectangle 30.png' },
    ],
};
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 text-center">
                        <div className="section_title portfolio_title text-center mt-3 mb-4">
                            <div className="section_main_title">
                                <h1 className='fw-bold wow animate__animated animate__fadeInDown'>Our Latest Works For Your Business</h1>
                            </div>
                        </div>
                    </div>
                </div>
