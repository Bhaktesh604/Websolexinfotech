...
//                                 <div className="card position-relative border-0 m-2">
//                                     <Link to={`/portfolio/${image.id}`} onClick={scrollToTop} className="card_img overflow-hidden z-1 rounded-3 position-relative">
//                                         <img
//                                             src={image.src}
//                                             alt={image.alt}
//                                             className="img-fluid portfolio-image"
...
//                                         </div>
//                                         <div className="all_icon position-absolute d-flex align-items-center justify-content-center gap-3">
//                                             <Link to={`/portfolio/${image.id}`} onClick={scrollToTop} className="text-bg-light rounded-5 d-flex align-items-center justify-content-center">
//                                                 <FaSearchPlus />
//                                             </Link>
//                                             <Link to="#" className="text-bg-light rounded-5 d-flex align-items-center justify-content-center">
//                                                 <CiLink />
