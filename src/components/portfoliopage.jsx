...
const portfolios = {
    ...
    'App Design': [
        ...
        { id: 2, name: 'App Design', discri: 'App Design', src: image6, alt: 'Rectangle 16.png' },
        { id: 3, name: 'App Design', discri: 'App Design', src: image7, alt: 'Rectangle 17 (2).png' },
        { id: 4, name: 'App Design', discri: 'App Design', src: image8, alt: 'Rectangle 18.png' },
    ],
    'Graphic Design': [
    ...
    'Web Development': [
        { id: 1, name: 'Web Development', discri: 'Web Development', src: image13, alt: 'Rectangle 23.png' },
        { id: 2, name: 'Web Development', discri: 'Web Development', src: image14, alt: 'Rectangle 24.png' },
        { id: 3, name: 'Web Development', discri: 'Web Development', src: image15, alt: 'Rectangle 25.png' },
        { id: 4, name: 'Web Development', discri: 'Web Development', src: image16, alt: 'Rectangle 26.png' },
    ],
    'App Development': [
        { id: 1, name: 'App Development', discri: 'App Development', src: image17, alt: 'Rectangle 27.png' },
        { id: 2, name: 'App Development', discri: 'App Development', src: image18, alt: 'Rectangle 28.png' },
        { id: 3, name: 'App Development', discri: 'App Development', src: image19, alt: 'Rectangle 29.png' },
        { id: 4, name: 'App Development', discri: 'App Development', src: image20, alt: 'Rectangle 30.png' },
    ],
};
